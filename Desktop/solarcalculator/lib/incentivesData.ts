export const incentivesData = {
  ...
  states: {
    ...
    PA: { 
      name: "Pennsylvania", 
      rebatePercent: 0.04, 
      description: "Solar Renewable Energy Credits (SRECs) and net metering." 
    },
    MD: { 
      name: "Maryland", 
      rebatePercent: 0.05, 
      description: "Maryland Solar Renewable Energy Credit program." 
    },
    MN: { 
      name: "Minnesota", 
      rebatePercent: 0.04, 
      description: "Made in Minnesota Solar Incentive Program." 
    },
    WI: { 
      name: "Wisconsin", 
      rebatePercent: 0.03, 
      description: "Focus on Energy rebates and net metering." 
    },
    OK: { 
      name: "Oklahoma", 
      rebatePercent: 0.04, 
    ...
    KS: { 
      name: "Kansas", 
      rebatePercent: 0.03, 
      description: "Property tax exemption and net metering programs." 
    }
  }
};
