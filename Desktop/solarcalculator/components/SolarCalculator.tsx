...
export default function SolarCalculator({ 
  ...
  const [result, setResult] = useState<{state:string; annualSavings:number; roiYears:string}|null>(null);
  ...
  return (
        <div className="max-w-lg mx-auto bg-background p-8 rounded-2xl shadow-md border border-divider">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-text-primary mb-2">Sunalyze - Solar Panel Savings Calculator</h1>
            <p className="text-text-secondary">Get your personalized savings estimate</p>
          </div>
      ...
      <div className="space-y-6">
        ...
        <div>
            ...
            <button
              ...
              className="w-full bg-cta hover:bg-cta-hover text-white py-3 px-6 rounded-lg font-semibold transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
            >
            ...
            <div className="mt-8 p-6 bg-background-light border border-divider rounded-xl">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-2 border-b border-divider">
                  ...
                  <span className="font-semibold text-text-primary">{result.state}</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-divider">
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="font-semibold text-text-primary">{result.roiYears} years</span>
                </div>
              </div>
